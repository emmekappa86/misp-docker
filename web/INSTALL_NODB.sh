...
installCore () {
  ...
  if [[ ! -d ${PATH_TO_MISP} ]]; then
    ...
    false; while [[ $? -ne 0 ]]; do checkAptLock; ${SUDO_WWW} git clone https://github.com/MISP/MISP.git --branch ${MISP_VER} ${PATH_TO_MISP}; done
...
installCoreRHEL () {
  ...
  $SUDO_WWW git clone https://github.com/MISP/MISP.git --branch ${MISP_VER}
  cd $PATH_TO_MISP
...
installMISPonKali () {
  ...
  sudo chown ${WWW_USER}:${WWW_USER} ${PATH_TO_MISP}
  cd ${PATH_TO_MISP}
  false; while [[ $? -ne 0 ]]; do ${SUDO_WWW} git clone https://github.com/MISP/MISP.git --branch ${MISP_VER} ${PATH_TO_MISP}; done
